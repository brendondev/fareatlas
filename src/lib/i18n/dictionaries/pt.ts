...
export const pt = {
  ...
  pricing: {
    ...
    title: "Comece grátis. Faça upgrade quando quiser todos os assentos.",
    lead: "Navegue em todas as ofertas e busque prêmios em Econômica de graça, pra sempre. O Premium abre todas as cabines e a janela completa de 12 meses com alertas por e-mail; o Pro adiciona rotas ilimitadas e alertas que checam duas vezes mais rápido — e todo plano mostra a tarifa em dinheiro ao lado dos pontos.",
    monthly: "Mensal",
    annual: "Anual",
    ...
    perMonth: "mês",
    perYear: "ano",
    whatYouGet: "O que você leva",
    upgradeUnlocks: "O upgrade desbloqueia",
    startFree: "Comece grátis",
    goToSearch: "Ir para a busca",
    createAccountToUpgrade: "Crie uma conta pra assinar",
